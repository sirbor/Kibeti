...
struct MshwariView: View {
    ...
    @ObservedObject var mshwariBalance = KibetiBalance.instance
                        ...
                        VStack(spacing: 10) {
                                    ...
                                    HStack(alignment: .center, spacing: 20) {
                                        if loanPercentage == 0 {
                                            ...
                                            Circle()
                                                ...
                                                .stroke(.kibetiGreen, lineWidth: 2.0)
                                                .rotationEffect(.degrees(-90))
                                                .frame(width: 50, height: 50)
                                                .overlay {
                                                    Text("\(Int(loanPercentage * 100))%")
                            ...
                            HStack(alignment: .top) {
                                Text("DEPOSIT")
                                    ...
                                    .padding(8)
                                    .background(selection == .deposit ? .kibetiGreen : .clear)
                                ...
                                Text("LOCK SAVINGS")
                                    ...
                                    .padding(8)
                                    .padding(.horizontal)
                                    .background(selection == .lock ? .kibetiGreen : .clear)
                                    .clipShape(RoundedRectangle(cornerRadius: 25.0))
                                    .onTapGesture {
                                        withAnimation(.bouncy) {
                                            selection = .lock
                                ...
                                Text("LOAN")
                                    ...
                                    .padding(8)
                                    .padding(.horizontal)
                                    .background(selection == .loan ? .kibetiGreen : .clear)
                                    .clipShape(RoundedRectangle(cornerRadius: 25.0))
                                    .onTapGesture {
                                        withAnimation(.bouncy) {
                                            selection = .loan
