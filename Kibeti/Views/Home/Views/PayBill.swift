            ...
            VStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        Text("POPULAR BILLS")
                        PopularBills(circleText: "KS", title: "kenya bureau of standards", textColor: .kibetiGreen)
                        PopularBills(circleText: "N", title: "NHIF", textColor: .kibetiGreen)
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                PopularBills(circleText: "V", title: "Viusasa", textColor: .red)
                PopularBills(circleText: "GT", title: "GO tv", textColor: .kibetiGreen)
                PopularBills(circleText: "JL", title: "jamii telecummunication", textColor: .kibetiGreen)
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                PopularBills(circleText: "S", title: "safaricom postpaid", textColor: .kibetiGreen)
                PopularBills(circleText: "S", title: "safaricom home", textColor: .kibetiGreen)
            }
            .padding(.horizontal)
        }
    }
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                PopularBills(circleText: "D", title: "D.LIGHT", textColor: .kibetiGreen)
                PopularBills(circleText: "SP", title: "SOLAR PANDA", textColor: .blue)
                PopularBills(circleText: "SK", title: "SUN KING", textColor: .cyan)
                PopularBills(circleText: "MS", title: "M-KOPA SOLAR", textColor: .kibetiGreen)
                PopularBills(circleText: "KP", title: "KPLC PREPAID", textColor: .kibetiGreen)
            }
            .padding(.horizontal)
        }
    }
